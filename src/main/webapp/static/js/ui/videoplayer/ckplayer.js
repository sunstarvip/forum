...
function ckstyle() { //定义总的风格
    var ck = new Object();
    ck.cpath='../../../mages/ui/videoplayer/style.zip';
	/*
	...
	*/
	...
	以下是播放器自带的二个插件
	*/
	ck.control_rel='../../../mages/ui/videoplayer/plugin/related.swf,../../../inmages/ui/videoplayer/related.xml,0';
	/*
		1、视频播放结束后显示相关精彩视频的插件文件（注意，视频结束动作设置成3时(即var flashvars={e:3})有效），
		2、xml文件是调用精彩视频的示例文件，可以自定义文件类型（比如asp,php,jsp,.net只要输出的是xml格式就行）,实际使用中一定要注意第二个参数的路径要正确
		3、第三个参数是设置配置文件的编码，0是默认的utf-8,1是gbk2312 
	*/
	ck.control_pv='../../../images/ui/videoplayer/plugin/Preview.swf,105,2000';
	/*
	视频预览插件
	...
	*/
	ck.cpt_share='../../../images/ui/videoplayer/share.xml';
	/*
	分享插件调用的配置文件地址
	调用插件开始
	*/
